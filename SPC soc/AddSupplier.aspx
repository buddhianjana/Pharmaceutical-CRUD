<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSupplier.aspx.cs" Inherits="SPC_soc.AddSupplier" %>
...
<head runat="server">
    <title></title>
    <link href="CSS/AddSupplier.css" rel="stylesheet" />
</head>
<body>
    ...
    <div class="container">
        ...
        <div>
            <asp:Button class="fbtn" ID="Button1" runat="server" Text="Add Supplier" OnClick="Button1_Click" />
        </div>
