<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStaff.aspx.cs" Inherits="SPC_soc.AddStaff" %>
...
<body>
    ...
    <div class="container">
        ...
        <div>
            <asp:Button class="fbtn" ID="Button1" runat="server" Text="Add Staff" OnClick="Button1_Click" />
        </div>
